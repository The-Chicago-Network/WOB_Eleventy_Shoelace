...
function stem() {
    ...
    this.l = function() {
        ...
        f = d.a - d.cursor;
        d.d = d.cursor;
        if (0 != d.h(v) && (d.c = d.cursor, h = d.h(b), 0 != h && l())) switch(h){
            case 1:
                d.c = d.cursor;
                if (!d.b("iendo")) break;
                break;
        ...
        b: {
            ...
            if (a()) break b;
            d.cursor = d.a - h;
            if (!(d.cursor < e)) if (n = d.f, d.f = e, d.d = d.cursor, h = d.h(m), 0 == h) d.f = n;
            else switch(d.c = d.cursor, d.f = n, h){
                case 1:
                    h = d.a - d.cursor;
                    d.g("u") ? (n = d.a - d.cursor, d.g("g") ? d.cursor = d.a - n : d.cursor = d.a - h) : d.cursor = d.a - h;
                    d.c = d.cursor;
                    if (!d.e()) break;
                    break;
                case 2:
        ...
        if (0 != h) switch(d.c = d.cursor, h){
            ...
            case 2:
                ...
                h = d.a - d.cursor;
                d.d = d.cursor;
                d.g("u") ? (d.c = d.cursor, n = d.a - d.cursor, d.g("g") ? (d.cursor = d.a - n, l() ? d.e() : d.cursor = d.a - h) : d.cursor = d.a - h) : d.cursor = d.a - h;
        }
        d.cursor = d.a - f;
        d.cursor = d.f;
        f = d.cursor;
